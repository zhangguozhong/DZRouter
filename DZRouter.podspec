#
#  Be sure to run `pod spec lint DZRouter.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zhangguozhong/DZRouter.git"
  ...
  s.source       = { :git => "https://github.com/zhangguozhong/DZRouter.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "Classes", "DZRouter/Classes/**/*.{h,m}"
